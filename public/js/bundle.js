...
var displayMap = function displayMap(locations) {
  ...
  var points = [];
  var pointA = new L.LatLng(locations[0].coordinates[1], locations[0].coordinates[0]);
  var pointB; // Add the rest of the locations

  locations.forEach(function (loc) {
    points.push([loc.coordinates[1], loc.coordinates[0]]);
    if (loc.coordinates[0] !== pointA.lat) pointB = new L.LatLng(loc.coordinates[1], loc.coordinates[0]);
    var pointList = [pointA, pointB];
    L.marker([loc.coordinates[1], loc.coordinates[0]]).addTo(map).bindPopup("<h1>Day: ".concat(loc.day, " ").concat(loc.description, "</h1>"), {
      autoClose: false
    }).openPopup();
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          ...
          if (res.data.status === 200) {
            (0, _alert.showAlert)('success', 'Profile has been updated successfully');
            window.setTimeout(function () {
              location.assign('/me');
            }, 200);
          }
  ...
  _regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          stripe = Stripe('pk_test_51NYXcOEPKPDPborLMtBiYqMdo0OTZ9oHdD7wMPGRnxVIGCV5LQ1qlvvxyVjRrjyH5YIm1AEF1GS6hn2pQ7lQcxgW00v6JReszV'); // 1) Get checkout session from API endpoint
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (res.data.status === 201) {
            (0, _alert.showAlert)('success', 'Your profile has been created successfully');
            window.setTimeout(function () {
              location.assign('/me');
            }, 200);
          }
...
// DOM Elements
var leaflet = document.getElementById('map'); // Forms

var loginForm = document.querySelector('.form--login');
var saveChangesForm = document.querySelector('.form-user-data');
var savePasswordForm = document.querySelector('.form-user-settings');
var signupForm = document.querySelector('.form--signup'); // Buttons

var logoutButton = document.querySelector('.nav__el--logout');
var bookButton = document.getElementById('book-tour'); // Map
...
if (saveChangesForm) {
  saveChangesForm.addEventListener('submit', function (e) {
    e.preventDefault();
...
if (savePasswordForm) {
  savePasswordForm.addEventListener('submit',
  /*#__PURE__*/
  function () {
    var _ref = _asyncToGenerator(
    /*#__PURE__*/
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 8;
            return (0, _signup.createAccount)({
              name: name,
              email: email,
              password: password,
